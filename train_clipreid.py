...
if __name__ == '__main__':
    ...
    if 'cc' in cfg.DATASETS.NAMES or 'last' in cfg.DATASETS.NAMES:
        train_loader_stage2, train_loader_stage1, val_loader, val_cc_loader, num_query, num_query_cc, \
            num_classes, num_cloth_classes, camera_num, view_num, train_pid2clothes = make_dataloader(cfg)
        
    else:
        train_loader_stage2, train_loader_stage1, val_loader, num_query, num_classes, num_cloth_classes, \
            camera_num, view_num, train_pid2clothes = make_dataloader(cfg)
        val_cc_loader = None
        num_query_cc = None

    model = make_model(cfg, num_class=num_classes, num_cloth_classes=num_cloth_classes, camera_num=camera_num, view_num = view_num)
    ...
    do_train_stage2(
        ...
        val_cc_loader, num_query_cc,
        # val_sc_loader, num_query_sc,
        train_pid2clothes
    )